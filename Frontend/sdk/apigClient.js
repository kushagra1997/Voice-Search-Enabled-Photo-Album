...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://1qsv7tmyfe.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.folderOptions = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['folder'], ['body']);
        
        var folderOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/{folder}').expand(apiGateway.core.utils.parseParametersToObject(params, ['folder'])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
